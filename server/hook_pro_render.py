...
def enhance_golden_opening_clip(
    ...
    *,
    ...
    from moviepy_editor import _write_clip, letterbox_fit
    ...
    try:
        fitted = letterbox_fit(clip, 1920, 1080)
        ...
        render_center_subtitle_png(sub_png, line)
        ...
        final = CompositeVideoClip([fitted, ov], size=(1920, 1080)).with_duration(
...
def build_black_caption_fadeout(
    ...
    *,
    ...
    if cap:
        ...
        render_center_subtitle_png(sub, cap, font_px=56)
        _run_ffmpeg(
            [
                "-hide_banner",
                "-f",
                "lavfi",
                "-i",
                f"color=c=black:s=1920x1080:r=30:d={fade:.3f}",
                "-loop",
                "1",
                "-i",
                str(sub),
    ...
    if cap:
        ...
        _run_ffmpeg(
            [
                ...
                "-filter_complex",
                (
                    f"[0:v]scale=1920:1080,fade=t=out:st={fade_st:.3f}:d={fade_d:.3f}:color=black[v0];"
                    f"[1:v]scale=1920:1080[sub];[v0][sub]overlay=0:0:format=auto,format=yuv420p[v];"
        ...
        _run_ffmpeg(
            [
                ...
                "-vf",
                (
                    f"scale=1920:1080,fade=t=out:st={fade_st:.3f}:d={fade_d:.3f}:color=black,"
                    "format=yuv420p"
                ),
                "-af",
    ...
    if cap:
        ...
        _run_ffmpeg(
            [
                ...
                str(dur),
                "-filter_complex",
                "[0:v]scale=1920:1080[v0];[1:v]scale=1920:1080[sub];"
